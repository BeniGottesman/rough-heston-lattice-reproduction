...
| 316 | 0.003165 | 0.16247 | 0.58883 | 0.41692 | 0.33769 | 0.13608 |
| 1000 | 0.001 | 0.12053 | 0.54004 | 0.36324 | 0.28606 | 0.106 |
| 3162 | 0.0003163 | 0.073194 | 0.46098 | 0.2821 | 0.21106 | 0.067837 |
| 10000 | 0.0001 | 0.05 | 0.40504 | 0.22927 | 0.1645 | 0.0475 |
| 31623 | 3.162e-05 | 0.033258 | 0.35062 | 0.18177 | 0.12444 | 0.032152 |
| 100000 | 1e-05 | 0.022496 | 0.30399 | 0.14435 | 0.094314 | 0.02199 |
| 316228 | 3.162e-06 | 0.016308 | 0.26965 | 0.11884 | 0.074638 | 0.016042 |
| 1000000 | 1e-06 | 0.011 | 0.23227 | 0.093212 | 0.055706 | 0.010879 |

Exponents fitted over the whole ladder, and over its last five points only (the prediction is asymptotic and the `kappa' -> 1/2` crossover is slow):

| quantity | exp in delta (all) | exp in delta (tail) | prediction | exp in eps_n (all) | exp in eps_n (tail) | prediction |
|---|---|---|---|---|---|---|
| E[G^0.2] | 0.1168 | 0.1194 | 0.1333 | 0.3314 | 0.3674 | 0.4000 |
| E[G^0.35] | 0.1878 | 0.1933 | 0.2333 | 0.5325 | 0.5945 | 0.7000 |
| E[G^0.45] | 0.2259 | 0.2325 | 0.3000 | 0.6405 | 0.7153 | 0.9000 |
| E[G^1.0] | 0.3206 | 0.3164 | 0.3333 | 0.9102 | 0.9737 | 1.0000 |
...
|---|---|---|
| 1. FF1 frozen-vs-unfrozen (discrete only) | 43s | 42.77 |
| 2. FF2 frozen-vs-frozen (coupled, mpu=1048576, M=1310720) | 1m31s | 91.84 |
| 3. FF2 resolution sensitivity (fixed n, varying fine grid) | 37s | 36.8 |
| 4. FF3 ordering L1 (non-constant coefficients, M=655360) | 29s | 29.47 |
| 5. FF4 exit-time reconciliation (exact law) | 2s | 2.26 |
| **total** | **3m46s** | **226.61** |
